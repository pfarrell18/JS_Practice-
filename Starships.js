...
for (i=0; i<charecters.length; i++){
   topush = []
  if (charecters[i].mass>50){
    topush.push(charecters[i].name, charecters[i].mass)
    Character_info.push(topush)
  } 
...
for (var i = 0; i< charecters.length; i++){
    starships={}
  if (charecters[i].starships.length >= 1){
    starships['name']=charecters[i].name
    starships['hasStarships']=charecters[i].starships
    all_info.push(starships)
  }
...
// starVehicles = []
for (i=0; i<charecters.length; i++){
  if (charecters[i].vehicles.length !==0 && charecters[i].starships.length!==0){
    starVehicles.push(charecters[i].name)
  }
}

console.log(starVehicles)